# Anleitung für Meikel - Tägliche Commits
...
```bash
git checkout -b feature/meikel-tag-X
```

> Ersetze **X** mit der Nummer des Tages (1, 2, 3, 4, 5, 6)

**Beispiele:**
- Tag 1: `git checkout -b feature/meikel-tag-1`
- Tag 2: `git checkout -b feature/meikel-tag-2`
- Tag 3: `git checkout -b feature/meikel-tag-3`
...
- **Meikel** - [Datum] - [Kurze Beschreibung was du gemacht hast]
```
...
- **Meikel** - 2025-02-20 - API-Dokumentation gelesen und getestet
```

#### Option B: Datei erstellen

Erstelle eine neue Datei `meikel-notizen.txt`:

```bash
# Auf Windows:
echo "Meikel - Tag X - [Beschreibung]" > meikel-notizen.txt
...
# Commit erstellen
git commit -m "docs: meikel tag X - [kurze Beschreibung]"
```
...
```bash
# Tag 1:
git commit -m "docs: meikel tag 1 - readme um team-info erweitert"

# Tag 2:
git commit -m "docs: meikel tag 2 - api getestet und notizen erstellt"

# Tag 3:
git commit -m "docs: meikel tag 3 - rechtschreibfehler korrigiert"

# Tag 4:
git commit -m "docs: meikel tag 4 - kommentare hinzugefuegt"

# Tag 5:
git commit -m "docs: meikel tag 5 - tests durchgefuehrt"

# Tag 6:
git commit -m "docs: meikel tag 6 - finale dokumentation"
```
...
```bash
git push -u origin feature/meikel-tag-X
```
...
3. Titel: `Meikel Tag X - [Beschreibung]`
...
# ## Team
# - Meikel - 2025-02-20 - Projekt-Setup verstanden

git add .
git commit -m "docs: meikel tag 1 - team-info hinzugefuegt"
...
git checkout main
git pull origin main
git checkout -b feature/meikel-tag-2

# Teste die API oder mache eine kleine Änderung
echo "Meikel - API-Tests durchgefuehrt" > meikel-tests.txt

git add .
git commit -m "docs: meikel tag 2 - api-tests dokumentiert"
git push -u origin feature/meikel-tag-2
```
...
git checkout main
git pull origin main
git checkout -b feature/meikel-tag-3
...
git add .
git commit -m "docs: meikel tag 3 - rechtschreibfehler korrigiert"
git push -u origin feature/meikel-tag-3
```
...
git checkout main
git pull origin main
git checkout -b feature/meikel-tag-4

# Füge Dokumentation hinzu
echo "Meikel - Code-Review durchgefuehrt" > meikel-review.txt

git add .
git commit -m "docs: meikel tag 4 - code-review dokumentiert"
git push -u origin feature/meikel-tag-4
```
...
git checkout main
git pull origin main
git checkout -b feature/meikel-tag-5

# Führe Tests durch und dokumentiere
git add .
git commit -m "docs: meikel tag 5 - tests dokumentiert"
git push -u origin feature/meikel-tag-5
```
...
git checkout main
git pull origin main
git checkout -b feature/meikel-tag-6

git add .
git commit -m "docs: meikel tag 6 - finale tests"
git push -u origin feature/meikel-tag-6
```
...
- [ ] Änderung machen
- [ ] `git add .`
- [ ] `git commit -m "docs: meikel tag X - ..."`
- [ ] `git push -u origin feature/meikel-tag-X`
